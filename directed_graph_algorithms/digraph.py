...
def main():
    """
    Main function to read a directed graph from a file, convert it to a NetworkX graph,
    ...
    networkx_graph = digraph.to_networkx_graph()
    # Use the spring layout for better positioning
