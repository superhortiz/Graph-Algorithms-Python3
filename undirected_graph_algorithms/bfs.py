...
class BFS:
    """
    Implements Breadth-First Search (BFS) for an undirected graph.
    """

    def __init__(self, graph, source):
        """
        Initializes the BFS object and performs BFS from the source vertex.
...
def main():
    """
    Main function to read a graph from a file, perform BFS, and print the path information.
    """
