...
class DFS:
    ...
    def __init__(self, graph, source):
        """
        Initializes the DFS object and performs DFS from the source vertex.
        
        Args:
            graph (Graph): The graph to perform DFS on.
            source (int): The source vertex from which to start the DFS.
        """
...
def main():
    """
    Main function to read a graph from a file, perform DFS, and print the path information.
    """
